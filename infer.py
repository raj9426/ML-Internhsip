...
if __name__ == '__main__':
    ...
    clf = load(str("C:\Users\shakt\OneDrive\Desktop\Disease-Prediction-from-Symptoms-master\Disease-Prediction-from-Symptoms-master\saved_modelrandom_forest.joblib"))
